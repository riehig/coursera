...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        return [
            html.Div(className='chart-item', children=[html.Div(children=R_chart1),html.Div(children=R_chart2)],style={'diaply':'flex'}),
            html.Div(className='chart-item', children=[html.Div(children=R_chart3),html.Div(children=R_chart4)],style={'diaply':'flex'})
            ]
